...
import io.github.realyusufismail.yusufsdiscordbot.ydl.entities.guild.channel.PublicThread;
...
public class PublicThreadReg extends ChannelReg implements PublicThread {
    public PublicThreadReg(@NotNull JsonNode json, long id, @NotNull YDL ydl) {
        super(json, id, ydl);
    }
