...
/**
 * Inspired from JDA's <a href="https://github.com/DV8FromTheWorld/JDA/blob/master/src/main/java/net/dv8tion/jda/api/hooks/ListenerAdapter.java"/> ListenersAdapter</a>
 */
